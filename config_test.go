...
func TestHideConfigSecrets(t *testing.T) {
	sc := &SafeConfig{}
	err := sc.ReloadConfig(nil, []string{"testdata/snmp-auth.yml"}, false)
	if err != nil {
...
func TestLoadConfigWithOverrides(t *testing.T) {
	sc := &SafeConfig{}
	err := sc.ReloadConfig(nil, []string{"testdata/snmp-with-overrides.yml"}, false)
	if err != nil {
...
func TestLoadMultipleConfigs(t *testing.T) {
	...
	err := sc.ReloadConfig(nil, configs, false)
	if err != nil {
...
func TestEnvSecrets(t *testing.T) {
	...
	sc := &SafeConfig{}
	err := sc.ReloadConfig(nil, []string{"testdata/snmp-auth-envvars.yml"}, true)
	if err != nil {
...
func TestEnvSecretsNotSpecified(t *testing.T) {
	sc := &SafeConfig{}
	err := sc.ReloadConfig(nil, []string{"testdata/snmp-auth-v2nocreds.yml"}, true)
	if err != nil {
