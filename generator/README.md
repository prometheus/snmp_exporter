...
modules:
  module_name:  # The module name. You can have as many modules as you want.
    ...
    # Note: Only the dynamic filters are included in the generated snmp.yml and passed to the snmp_exporter. Static filters are handled at generation time by the generator and do not appear in the runtime configuration.
